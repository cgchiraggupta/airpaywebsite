...
export function FAQSection() {
  ...
  const faqs = [
    { q: 'DOES IT WORK WITHOUT INTERNET?', a: 'Affirmative. AirPay leverages GSM signaling (*99# USSD) which operates independently of IP connectivity. Works on 2G/EDGE networks.' },
